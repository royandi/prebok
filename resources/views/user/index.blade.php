									...
									<table class="table table-hover">
										...
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$user->alamat}}</td>
                                                <td><a href="/user/{{$user->id}}/edit" class="btn btn-warning btn-sm">Edit</td>
                                                <td><a href="/user/{{$user->id}}/delete" class="btn btn-danger btn-sm" onClick="return confirm('yakin mau dihapus ?')">Delete</td>
                                            </tr>
                                            @endforeach
										</tbody>
									</table>
